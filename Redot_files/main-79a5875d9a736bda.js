(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[179], {
    ...
    2390: function() {
        ...
        if ("undefined" != typeof window && "serviceWorker"in navigator && "undefined" != typeof caches) {
            ...
            window.workbox.addEventListener("installed", async () => {
                let e = window.performance.getEntriesByType("resource").map(e => e.name).filter(e => e.startsWith(`${window.location.origin}/static/`) && e.endsWith(".json"))
        ...
        t.default = class {
            ...
            getDataHref(e) {
                ...
                return (e => {
                    ...
                    return a.addBasePath("/static/".concat(this.buildId).concat(t).concat(p), !0)
                }
    ...
    5143: function(e, t, r) {
        ...
        t.formatNextPathnameInfo = function(e) {
            ...
            e.buildId && (t = o.addPathSuffix(a.addPathPrefix(t, "./".concat(e.buildId)), "/" === e.pathname ? "index.json" : ".json")),
    ...
    8780: function(e, t, r) {
        ...
        t.getNextPathnameInfo = function(e, t) {
            ...
            u.basePath = i),
            !0 === t.parseData && u.pathname.startsWith("/static/") && u.pathname.endsWith(".json")) {
                let e = u.pathname.replace(/^\/static\/data\//, "").replace(/\.json$/, "").split("/")
                  , t = e[0];
    ...
    3336: function(e, t) {
        ...
        t.isBot = function(e) {
            return /Googlebot|Mediapartners-Google|AdsBot-Google|googleweblight|Storebot-Google|Google-PageRenderer|Bingbot|BingPreview|Slurp|DuckDuckBot|baiduspider|yandex|sogou|TVBot|bitlybot|tumblr|vkShare|quora link preview|facebookexternalhit|facebookcatalog|Twitterbot|applebot|redditbot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|ia_archiver/i.test(e)
        }
    },
    428: function(e, t) {
        "use strict";
